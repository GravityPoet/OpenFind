...
struct ClipboardHistoryView: View {
    ...
    var body: some View {
        ...
        .frame(
            ...
            minHeight: store.isPreviewVisible
                ? ClipboardHistoryPanelMetrics.expandedMinimumSize.height
                : ClipboardHistoryPanelMetrics.compactMinimumSize.height,
            idealHeight: store.isPreviewVisible
                ? ClipboardHistoryPanelMetrics.expandedDefaultSize.height
                : ClipboardHistoryPanelMetrics.compactDefaultSize.height
        )
        .background {
